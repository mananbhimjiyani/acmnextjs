            ...
            <footer className="footer background-image">
                <div className="mx-auto max-w-screen-xl p-4 py-6 lg:py-8 rounded-2xl text-center">
                    <div className="md:flex md:justify-between">
                        ...
                        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 py-8">
                            <div>
                                ...
                                <ul className="text-gray-500 dark:text-gray-200 font-medium">
                                    <li className="mb-4">
                                        <a href="https://www.acm.org//" className="hover:underline">ACM</a>
                                    </li>
                                    <li>
                    ...
                    <hr className="my-6 border-gray-200 sm:mx-auto light:border-gray-200 lg:my-8"/>
                    <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-300">© 2023 <a
              href="https://acm.org/" className="hover:underline">SIT-ACM™</a>. All Rights Reserved.
          </span>
